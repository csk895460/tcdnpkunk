...
#===============================================================
    ...
    #===================== QUALITY =================================
        ...
        if raw_text3 == 'df':
            CR = '<a href="https://t.me/Prashant_singh_Pranshu">𝐏𝐑𝐀𝐒𝐇𝐀𝐍𝐓 𝐒𝐈𝐍𝐆𝐇❤️</a>'
        else:
            CR = raw_text3    
...
#===============================================================
            if raw_text4 == "YES":
                ...
                cc1 = f'⋅ ─  **{t_name}**  ─ ⋅\n\n[📁] **File ID** : {str(count).zfill(3)}.\n**𝑭𝒊𝒍𝒆 𝑵𝒂𝒎𝒆** : **{v_name} [❖ 𝐏𝐑𝐀𝐒𝐇𝐀𝐍𝐓 𝐒𝐈𝐍𝐆𝐇  ❖ ™].pdf \n\n**𝑩𝒂𝒕𝒄𝒉 𝑵𝒂𝒎𝒆** : `{b_name}`\n\n**𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅𝒆𝒅 𝑩𝒚 : {CR}**'

            else:
                cc = f'**[📹] Video_ID : {str(count).zfill(3)}.**\n\n**𝑽𝒊𝒅𝒆𝒐 𝑵𝒂𝒎𝒆** : ** {name1} {res} [❖𝐏𝐑𝐀𝐒𝐇𝐀𝐍𝐓 𝐒𝐈𝐍𝐆𝐇  ™].mkv\n\n**𝑩𝒂𝒕𝒄𝒉 𝑵𝒂𝒎𝒆** : `{b_name}`\n\n**𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅𝒆𝒅 𝑩𝒚 : {CR}**'
                cc1 = f'**[📁] File_ID : {str(count).zfill(3)}.**\n\n**𝑭𝒊𝒍𝒆 𝑵𝒂𝒎𝒆** : **{name1} [❖ 𝐏𝐑𝐀𝐒𝐇𝐀𝐍𝐓 𝐒𝐈𝐍𝐆𝐇  ❖ ™].pdf \n\n**𝑩𝒂𝒕𝒄𝒉 𝑵𝒂𝒎𝒆** : `{b_name}`\n\n**𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅𝒆𝒅 𝑩𝒚 : {CR}**'                             
